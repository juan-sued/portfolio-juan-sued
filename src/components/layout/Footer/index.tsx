...
export default function Footer() {
  return (
    <>
      ...
      <section className="border-t-2 gap-20 boder-slate-200 border-slate-900 blur-radial-gradient backdrop-blur-md  bg-blueTheme-500 dark:bg-opacity-90 mt-[458px]  md:mt-[325px]  p-20 flex flex-col items-center  w-full">
