  ...
  return (
    <>
      <div className="relative duration-300  hover:-rotate-0 [transform:rotate3d(1_,-1,_1,_60deg)] group  border-indigo-800 border-opacity-50  bg-white blur-radial-gradient bg-opacity-10 border-4  overflow-hidden rounded-2xl  h-52 w-72  p-5 flex flex-col items-start gap-4">
        ...
        <button className="duration-300 hover:bg-indigo-900 border hover:text-gray-50 bg-gray-50 font-semibold text-indigo-800 px-3 py-2 flex flex-row items-center gap-3">
          Dowload CV
          <svg
            y="0"
