    ...
    <>
      ...
      <main className="grid  gap-2 p-4 mt-16 w-full ">
        ...
        <section className="w-full flex justify-center">
          <div className="contentIntroduction mt-[60px] w-[90%] max-w-[600px] h-96 p-2  backdrop-blur-md  rounded-3xl shadow-shadow-border-white  border border-white border-opacity-10">
